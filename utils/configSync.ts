...
export const KEY_MAP: Record<string, string> = {
  ...
  showActiveLabel: 'D', activeLabelFormat: 'E', startFromJan: 'F', groupBy: 'G',
  showSeasonLabels: 'H', seasonsSideBySide: 'I', anchorTodayToRealTime: 'J', blockAlignment: 'K',
  isLifeMode: 'L', birthDate: 'M', lifeExpectancy: 'N', lifeGranularity: 'O',
  showLifeStats: 'P', showQiQuotes: 'Q', quotesCategory: 'R', selectedQuoteId: 'S',
  customQuoteText: 'T', showHeaderPlugin: 'U', labelRotation: 'V', customTitle: 'W',
