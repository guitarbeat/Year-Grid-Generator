...
export const Toggle: React.FC<{ 
  ...
  <div className="flex items-center justify-between group py-1">
    ...
    <label className="toggle-checkbox relative inline-flex items-center cursor-pointer">
      ...
      />
      <div className="toggle-track peer-focus-visible:ring-2 peer-focus-visible:ring-orange-500 peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-[#0a0a0a] peer-focus-visible:outline-none">
