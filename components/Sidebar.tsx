                ...
                <div className="grid grid-cols-5 gap-2" role="radiogroup" aria-labelledby="color-theme-label">
                  {THEMES.map(t => (
                    <button 
                      ...
                      className={`
                        w-full aspect-square rounded-full border-2 transition-all relative overflow-hidden active:scale-95 shadow-lg focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a1a1a]
