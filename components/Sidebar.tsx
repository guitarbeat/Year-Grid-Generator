        ...
        <div className="flex-1 px-4 divide-y divide-border/40 pb-20">
          ...
          <SidebarSection label="Labels & Font">
            <div className="space-y-6">
              ...
              <div>
                <span id="theme-label" className="text-[9px] text-gray-600 font-bold tracking-widest mb-3 block uppercase">Color Theme</span>
                <div role="radiogroup" aria-labelledby="theme-label" className="grid grid-cols-5 gap-2">
                  {THEMES.map(t => (
                    <button 
                      key={t.name}
                      role="radio"
