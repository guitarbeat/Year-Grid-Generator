          ...
          <SidebarSection label="Labels & Font">
            <div className="space-y-6">
              ...
              <div>
                ...
                <div role="radiogroup" aria-labelledby="color-theme-label" className="grid grid-cols-5 gap-2">
                  {THEMES.map(t => {
                    ...
                    return (
                      <button
                        ...
                        className={`
                          w-full aspect-square rounded-full border-2 transition-all relative overflow-hidden active:scale-95 shadow-lg focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-black
