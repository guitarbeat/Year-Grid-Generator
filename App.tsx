...
const App: React.FC = () => {
  ...
  // ⚡ Bolt: Debounce config sync to URL/localStorage
  // Impact: Prevents main-thread blocking and history rate-limiting during rapid UI interactions (e.g., slider drags)
  useEffect(() => {
