...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // ⚡ Bolt: Debounce config synchronization to external storage (URL/localStorage)
    // Impact: Prevents main-thread blocking and browser rate-limiting during high-frequency UI updates (like sliders)
